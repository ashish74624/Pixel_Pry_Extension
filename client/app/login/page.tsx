...
export default function Login() {
  ...
  return (
    <Vortex backgroundColor="black" rangeY={800} particleCount={800} className="flex items-center flex-col justify-center px-2 md:px-10  py-4 dark h-screen w-screen ">
